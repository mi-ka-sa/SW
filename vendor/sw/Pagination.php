...
class Pagination
{
    ...
    public function getHtml()
    {
        ...
        $forward = null; // link to next
        $startpage = null; // link to the start
        $endpage = null; // link to the end
    ...
    // indicates the product from which you want to start the selection of goods
    // for SQL query LIMIT
