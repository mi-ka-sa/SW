                        ...
                        <?php foreach (\sw\App::$app->getProperty('languages') as $k => $lang): ?>
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_desc[<?= $lang['id'] ?>][title]"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_desc[<?= $lang['id'] ?>][description]"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_desc[<?= $lang['id'] ?>][keywords]"
                                           class="form-control" id="keywords" placeholder="Keywords"
                                           value="<?= h($page[$lang['id']]['keywords']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="content">Contnent</label>
                                    <textarea name="page_desc[<?= $lang['id'] ?>][content]"
                                              class="form-control editor" id="content" rows="3"
                                              placeholder="Contnent"><?= h($page[$lang['id']]['content']) ?></textarea>
                                </div>
