        ...
        <table class="table text-start">
            ...
            <tbody>
                <?php foreach($_SESSION['cart'] as $id => $item): ?>
                    <tr>
                        <td>
                            <a href="product/$item['clug']"><img src="<?= PATH . $item['img']?>" alt=""></a>
                        </td>
                        <td><a href="product/$item['clug']"><?= $item['title']?></a></td>
                        <td><?= $item['qty']?></td>
                        <td><?= $item['price']?></td>
                        <td><a href="cart/delete?<?= $id ?>" class="del-item" data-id="<?= $id ?>"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                <tr>
